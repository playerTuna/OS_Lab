...
/* Note: To run this program, you need to create two separate files for client1 and client2.
    Run client1 first, then run client2. You can send messages from client1 to client2 and vice versa.
    To exit the program, type 'exit' in either client. The program will automatically clean up the message queues upon termination.

    Compilation:
    make

    Execution:
    ./chat_client1 # In one terminal
    ./chat_client2 # In another terminal

    Code by: Khanh Nguyen
*/